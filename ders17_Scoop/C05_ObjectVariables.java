package ders17_Scoop;

import ders16_DoWhileLoop.C02_DoWhileLoop;
import ders16_DoWhileLoop.C03_SifreKontrolü;
...
public class C05_ObjectVariables {
    public static void main(String[] args) {
        ...
        C03_ObjectVariables pers1= new C03_ObjectVariables();//object olusturma tıpkı Scanner scan=new Scanner().. gibi
        ...
        System.out.println(pers3.persTelefonu); //"312 2134567
